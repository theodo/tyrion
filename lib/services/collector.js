...
var Collector = /** @class */ (function () {
    function Collector(scanningPath) {
        ...
        this.debt = new debt_1.default();
    }
    Collector.prototype.collect = function () {
        return __awaiter(this, void 0, void 0, function () {
            var allNotHiddenFiles, notHiddenFiles, allHiddenFiles, hiddenFiles, allFiles, _i, allFiles_1, fileName, lines, _a, lines_1, line, debtItem;
            var _this = this;
            return __generator(this, function (_b) {
                allNotHiddenFiles = this.scanningPath + '/**/*.*';
                notHiddenFiles = glob.sync(allNotHiddenFiles);
                allHiddenFiles = this.scanningPath + '/**/.*';
                hiddenFiles = glob.sync(allHiddenFiles);
                ...
                for (_i = 0, allFiles_1 = allFiles; _i < allFiles_1.length; _i++) {
                    ...
                    for (_a = 0, lines_1 = lines; _a < lines_1.length; _a++) {
                        line = lines_1[_a];
                        debtItem = this.parseDebtItemFromDebtLine(line, fileName);
                        this.debt.addDebtItem(debtItem);
                    }
                }
                return [2 /*return*/, this.debt];
            });
        });
    };
